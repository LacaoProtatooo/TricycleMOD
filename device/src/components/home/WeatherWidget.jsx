...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 13, fontWeight: '700', color: colors.orangeShade7, marginBottom: 4 },
  loadingText: { marginTop: spacing.xsmall, color: colors.orangeShade5, fontSize: 12 },
  currentRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  currentTemp: { fontSize: 20, fontWeight: '700', color: colors.primary },
  currentDesc: { fontSize: 12, color: colors.orangeShade5 },
  meta: { alignItems: 'flex-end' },
  small: { fontSize: 10, color: colors.orangeShade5 },
  hourlyScroll: { marginTop: 4 },
  hourItem: { paddingHorizontal: 8, paddingVertical: 6, marginRight: 6, backgroundColor: colors.ivory1, borderRadius: 6, minWidth: 64, alignItems: 'center' },
  hourText: { fontSize: 10, color: colors.orangeShade5 },
  hourTemp: { fontSize: 14, fontWeight: '700', color: colors.orangeShade7, marginVertical: 2 },
  hourDesc: { fontSize: 10, color: colors.orangeShade5, textAlign: 'center' },
});